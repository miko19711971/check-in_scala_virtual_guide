...
const T = {
  en: {
    ...
    step5_note:
      'Lockbox code: 6793. Once you locate the key box, enter the combination, open the slot from the top, take the key, close the slot and MIX THE NUMBERS. Use the grey key to get inside the apartment.',
  ...
  es: {
    ...
    step5_note:
      'Código de la caja: 6793. Una vez localizada la caja, introduce la combinación, abre la ranura por arriba, toma la llave, cierra la ranura y MEZCLA LOS NÚMEROS. Usa la llave gris para entrar al apartamento.',
  ...
  fr: {
    ...
    step5_note:
      'Code de la boîte : 6793. Une fois la boîte repérée, saisissez la combinaison, ouvrez par le haut, prenez la clé, refermez et MÉLANGEZ LES CHIFFRES. Utilisez la clé grise pour entrer dans l’appartement.',
  ...
  de: {
    ...
    step5_note:
      'Code der Schlüsselkassette: 6793. Sobald Sie die Kassette gefunden haben, geben Sie die Kombination ein, öffnen Sie den Schlitz oben, entnehmen Sie den Schlüssel, schließen Sie den Schlitz und MISCHEN SIE DIE ZAHLEN. Mit dem grauen Schlüssel die Wohnung öffnen.',
  ...
  it: {
    ...
    step5_note:
      'Combinazione del lucchetto: 6793. Trovata la key box, inserisci la combinazione, apri lo sportelletto dall’alto, prendi la chiave, richiudi lo sportelletto e MESCOLA I NUMERI. Usa la chiave grigia per entrare in appartamento.',
